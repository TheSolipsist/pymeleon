...
viewer = pym.DSL(
    ...
    name="numpy_test"
) >> pym.GeneticViewer(use_pretrained=True, hyperparams={"num_epochs": 10000}, device_str="cuda")
...
def test():
    ...
    y = [4.2, 7.21, 12]
    c = "test"
    return (test_example(ex_1, x),
            test_example(ex_2, x, y),
            test_example(ex_3, x, y),
            test_example(ex_4, x, y),
            test_example(ex_5, x, y, c))
