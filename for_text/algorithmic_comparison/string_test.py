...
@timer
def ex_2(viewer, a: str, b: str, c: str):
    """
    Apply 2 prefixes
    """
...
@timer
def ex_3(viewer, a: str, b: str, c: str, d: str):
    """
...
@timer
def ex_4(viewer, a: str, b: str, c: str, d: str):
    """
...
@timer
def ex_5(viewer, a: str, b: str, c: str, d: str):
    """
...
def test(fitness_str: str):
    ...
    prefix = "banana"
    postfix = "apple"
    return (test_example(viewer, ex_1, x, prefix),
            test_example(viewer, ex_2, x, y, prefix),
            test_example(viewer, ex_3, x, y, prefix, postfix),
            test_example(viewer, ex_4, x, y, prefix, postfix),
            test_example(viewer, ex_5, x, y, prefix, postfix))
